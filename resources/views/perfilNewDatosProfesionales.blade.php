<x-layout>
    <div role="tablist" class="tabs tabs-bordered">
        ...
        <a role="tab" class="tab text-gray-500 " href="/perfilNew/DatosAcademicos">
        ...
        <a role="tab" class="tab tab-active text-primary-light" href="/perfilNew/DatosProfesionales" >
        ...
        <div role="tabpanel" class="tab-content pt-10 mx-52">
            <form class="space-y-6" method="POST" id="dniForm">
                <div class="grid">
                    <label class="block text-lg font-medium leading-6 text-gray-900">Situación Laboral</label>
                    <div class="mt-2 flex items-center space-x-6">
                        <div class="flex items-center">
                            <input id="empleado" name="situacionLaboral" type="radio" value="empleado" required class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                            <label for="empleado" class="ml-2 block text-sm font-medium leading-6 text-gray-900">Empleado</label>
                        </div>
                        <div class="flex items-center px-12">
                            <input id="desempleado" name="situacionLaboral" type="radio" value="desempleado" required class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                            <label for="desempleado" class="ml-2 block text-sm font-medium leading-6 text-gray-900">Desempleado</label>
                        </div>
                        <div class="flex items-center">
                            <input id="autonomo" name="situacionLaboral" type="radio" value="autonomo" required class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                            <label for="autonomo" class="ml-2 block text-sm font-medium leading-6 text-gray-900">Autónomo</label>
                        </div>
                    </div>
                </div>
                ...
                <!-- Empresa Actual -->
                <div class="grid">
                    <label for="empresaActual" class="block text-lg font-medium leading-6 text-gray-900">Empresa Actual</label>
                    <div class="relative mt-2">
                        <input id="empresaActual" name="empresaActual" type="text" required class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <!-- Puesto o Titulo Laboral Actual -->
                <div class="grid">
                    <label for="puestoActual" class="block text-lg font-medium leading-6 text-gray-900">Puesto o Título Laboral Actual</label>
                    <div class="relative mt-2">
                        <input id="puestoActual" name="puestoActual" type="text" required class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <!-- Industria o Sector de la Empresa Actual -->
                <div class="grid">
                    <label for="sector" class="block text-lg font-medium leading-6 text-gray-900">Industria o Sector de la Empresa Actual</label>
                    <div class="relative mt-2">
                        <select id="sector" name="sector" required class="bg-white block w-full pl-3 pr-10 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <!-- Dirección de la Empresa Actual -->
                <div class="grid">
                    <label for="direccionEmpresa" class="block text-lg font-medium leading-6 text-gray-900">Dirección de la Empresa Actual</label>
                    <div class="relative mt-2">
                        <input id="direccionEmpresa" name="direccionEmpresa" type="text" required class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <!-- Redes Profesionales -->
                <div class="grid">
                    <label for="redesProfesionales" class="block text-lg font-medium leading-6 text-gray-900">Redes Profesionales</label>
                    <div class="relative mt-2">
                        <input id="redesProfesionales" name="redesProfesionales" type="url" placeholder="Enlace a LinkedIn o portafolio web" required class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <!-- Curriculum Vitae -->
                <div class="grid">
                    <label for="curriculumVitae" class="block text-lg font-medium leading-6 text-gray-900">Curriculum Vitae</label>
                    <div class="mt-2 flex justify-center">
                        <input type="file" class="file-input file-input-bordered w-3/4" />
                    </div>
                </div>


                <!-- Disponibilidad para Ofertas Laborales -->
                <div class="grid">
                    <label class="block text-lg font-medium leading-6 text-gray-900">Disponibilidad para Ofertas Laborales</label>
                    <div class="mt-2 flex items-center space-x-6">

                        <div class="mt-2 flex items-center">
                            <input id="disponibilidadSi" name="disponibilidad" type="radio" value="si" required class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                            <label for="disponibilidadSi" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Sí</label>
                        </div>
                        <div class="mt-2 flex items-center px-24">
                            <input id="disponibilidadNo" name="disponibilidad" type="radio" value="no" required class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                            <label for="disponibilidadNo" class="ml-3 block text-sm font-medium leading-6 text-gray-900">No</label>
                        </div>
                    </div>
                </div>
