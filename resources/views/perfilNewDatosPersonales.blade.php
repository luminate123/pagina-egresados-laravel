<x-layout>
    <div role="tablist" class="tabs tabs-bordered">
        <a role="tab" class="tab tab-active text-primary-light" href="/perfilNew/DatosPersonales" >
        ...
        <div role="tabpanel" class="tab-content pt-10 mx-52">
            <form class="space-y-6" method="POST" id="dniForm">
                <div class="grid">
                    <label for="dni" class="block text-lg font-medium leading-6 text-gray-900">Documento de Identidad</label>
                    <div class="relative mt-2">
                        <input id="dni" name="dni" disabled type="text" required maxlength="8" class="bg-gray-300 block w-full pl-3 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="grid">
                    <label for="numeroTelefono" class="block text-lg font-medium leading-6 text-gray-900">Número de Telefónico</label>
                    <div class="relative mt-2">
                        <input id="numeroTelefono" name="numeroTelefono" type="tel" required pattern="9[0-9]{8}" title="El número telefónico debe ser de 9 dígitos y comenzar con 9" class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                
                <div class="grid">
                    <label for="email" class="block text-lg font-medium leading-6 text-gray-900">Correo Electrónico</label>
                    <div class="relative mt-2">
                        <input id="email" name="email" type="email" required class="bg-white block w-full pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
        ...
        <a role="tab" class="tab text-gray-500" href="/perfilNew/DatosProfesionales" >
            <svg class="pr-1" xmlns="http://www.w3.org/2000/svg" width="22" height="24" viewBox="0 0 19 21" fill="none">
