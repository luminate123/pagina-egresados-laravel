            ...
            <div role="tablist" class="tabs tabs-lifted">
                        ...
                        <form method="POST" action="{{$action1}}">
                            ...
                            <div class="flex space-x-4  ">
                                <div class="grid">
                                    ...
                                    <div class="mt-2">
                                        <input id="fecha_nacimiento" name="fecha_nacimiento" type="{{$tipo_date}}" value="{{$fecha}}" {{$prop}} class="bg-white block w-96 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                <div class="grid ">
                                    ...
                                    <div class="flex pt-1">
                                        <div class="form-control">
                                            <label class="label cursor-pointer space-x-3">
                                                ...
                                                <input type="radio" id="genero" name="genero" value="Masculino" {{$require}} class="radio checked:bg-blue-500" {{$prop1}} {{$prop}} />
                                            </label>
                                        </div>
                                        <div class="form-control">
                                            <label class="label cursor-pointer space-x-3">
                                                <span class="label-text">Femenino</span>
                                                <input id="genero" type="radio" name="genero" value="Femenino" {{$require}} class="radio checked:bg-blue-500" {{$prop2}} {{$prop}} />
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid justify-items-start">
                                ...
                                <div class="mt-2">
                                    <input id="nacionalidad" name="nacional" type="text" value="{{$nacionalidad}}" {{$prop}} class="bg-white block w-86 pl-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                ...
                <input type="radio" name="my_tabs_2" role="tab" class="tab" aria-label="Datos Academicos" />
                        ...
                        <form method="POST" action="{{ $actionacad }}">
                            ...
                            <div class="flex justify-center space-x-4">
                                <div class="grid">
                                    ...
                                    <div class="mt-2">
                                        <select {{$propacad}} {{$requireacad}} id="bachiller_academico" name="bachiller_academico" class="bg-white block w-44 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="grid">
                                    ...
                                    <div class="mt-2">
                                        <select {{$propacad}} {{$requireacad}} id="titulo_academico" name="titulo_academico" class="bg-white block w-44 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <div class="grid">
                                ...
                                <div class="mt-2">
                                    <input {{$propacad}} {{$requireacad}} id="maestria" name="maestria" type="text" value="{{$maestria}}" class="bg-white block min-w-96 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="grid">
                                <label for="doctorado" class="block text-sm font-medium leading-6 text-gray-900">Doctorado</label>
                                <div class="mt-2">
                                    <input {{$propacad}} {{$requireacad}} id="doctorado" name="doctorado" type="text" value="{{$doctorado}}" class="bg-white block min-w-96 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="flex space-x-4 mt-5">
                ...
                <!-- tab3 -->
                <input type="radio" name="my_tabs_2" role="tab" class="tab" aria-label="Datos Profesionales" />
                <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    <div class="grid justify-center space-y-3">
                            ...
                            <div class="flex pt-1 space-x-10">
                                <div class="form-control">
                                    <label class="label cursor-pointer space-x-3">
                                        ...
                                        <input type="radio" id="situacion_laboral" name="situacion_laboral" value="Empleado" class="radio checked:bg-blue-500" {{$prop1prof}} {{$disableprof}} />
                                    </label>
                                </div>
                                <div class="form-control">
                                    <label class="label cursor-pointer space-x-3">
                                        <span class="label-text">Desempleado</span>
                                        <input type="radio" id="situacion_laboral" name="situacion_laboral" value="Desempleado" class="radio checked:bg-blue-500" {{$prop2prof}} {{$disableprof}} />
                                    </label>
                                </div>
                                <div class="form-control">
                                    <label class="label cursor-pointer space-x-3">
                                        <span class="label-text">Freelance</span>
                                        <input type="radio" id="situacion_laboral" name="situacion_laboral" value="Freelance" class="radio checked:bg-blue-500" {{$prop3prof}} {{$disableprof}} />
                                    </label>
                                </div>
                            </div>
                            <div class="grid">
                                ...
                                <div class="mt-2">
                                    <input id="empresa_actual" name="empresa_actual" type="text" value="{{$empresa}}" {{$disableprof}} class="bg-white block min-w-full p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="grid">
                                <label for="puesto_actual" class="block text-sm font-medium leading-6 text-gray-900">Puesto Actual</label>
                                <div class="mt-2">
                                    <input id="puesto_actual" name="puesto_actual" type="text" value="{{$puesto}}" {{$disableprof}} class="bg-white block min-w-full p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="grid">
                                <label for="sector_empresa_actual" class="block text-sm font-medium leading-6 text-gray-900">Sector de la Empresa</label>
                                <div class="mt-2">
                                    <input id="sector_empresa_actual" name="sector_empresa_actual" value="{{$sector}}" {{$disableprof}} type="text" class="bg-white block min-w-full p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="grid">
                                <label for="redes_sociales" class="block text-sm font-medium leading-6 text-gray-900">LinkedIn o Portafolio Web</label>
                                <div class="mt-2">
                                    <input id="redes_sociales" name="redes_sociales" type="url" value="{{$link}}" {{$disableprof}} class="bg-white block min-w-full p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                        </form>
                        {{$scripttoast2 ?? ''}}
                        ...
                        <button id="submitBtnprof" type="button" onclick="submitForms()" class="{{$hidden1prof}} {{!$hidden2prof}}  flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ">Guardar</button>
                ...
                <!-- tab 4 -->
                <input type="radio" name="my_tabs_2" role="tab" class="tab" aria-label="Datos Adicionales" />
                <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    <div class="grid justify-center space-y-3">
                        <form method="POST" action="{{$certaccion}}">
                            ...
                            <div class="grid">
                                ...
                                <div class="mt-2">
                                    <input id="nombrecer" name="nombrecer" type="text" value="" class="bg-white block min-w-96 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="grid mt-4">
                                <label for="descripcioncer" class="block text-sm font-medium leading-6 text-gray-900">Descripcion</label>
                                <div class="mt-2">
                                    <input id="descripcioncer" name="descripcioncer" type="text" value="" class="bg-white block min-w-96 p-3 rounded-md border-0 py-1.5 text-sky-800 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="flex space-x-4 mt-5">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', (event) => {
                        // Obtener el nombre del input de radio almacenado en localStorage
                        const activeTab = localStorage.getItem('activeTab');

                        if (activeTab) {
                            // Si hay un input de radio almacenado, marcarlo como seleccionado
                            document.querySelector(`input[name="my_tabs_2"][aria-label="${activeTab}"]`).checked = true;
                        }

                        // Agregar evento de cambio a todos los inputs de radio
                        document.querySelectorAll('input[name="my_tabs_2"]').forEach((tab) => {
                            tab.addEventListener('change', (event) => {
                                // Guardar el aria-label del input de radio seleccionado en localStorage
                                localStorage.setItem('activeTab', event.target.getAttribute('aria-label'));
                            });
                        });
                    });
